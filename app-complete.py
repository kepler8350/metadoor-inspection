...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .btn-primary:active { background: #164a7a; transform: scale(0.98); }
    ...
    .district-btn { width: 100%; padding: 10px 12px; background: white; border: 1px solid #ddd; border-radius: 6px; font-size: 13px; font-weight: 500; color: #333; cursor: pointer; margin-bottom: 4px; text-align: left; transition: all 0.2s; font-family: inherit; }
    .district-btn:active { background: #f0f0f0; }
    ...
    .district-title { font-size: 13px; font-weight: 700; color: #1e5a96; margin-bottom: 10px; padding-bottom: 8px; border-bottom: 1px solid #eee; }
    .location-item { padding: 11px; background: white; border-radius: 6px; margin-bottom: 8px; border: 1px solid #eee; cursor: pointer; font-size: 13px; color: #333; transition: all 0.2s; }
    ...
    .no-selection { text-align: center; padding: 40px 16px; color: #999; font-size: 13px; }
    ...
    .inspection-step { font-size: 11px; color: rgba(255, 255, 255, 0.7); }
...
<body>
    ...
    <div class="app-content">
      ...
      <div class="screen district-screen">
        ...
        <div class="content-area">
          ...
          <div class="right-panel">
            ...
            <div class="no-selection" id="no-selection">왼쪽에서 구를 선택하세요</div>
          </div>
        </div>
      </div>
      ...
      <div class="screen inspection-screen">
        <div class="inspection-info">
          <div class="inspection-name" id="insp-name">사상구 - 삼락공원관리사무소</div>
          <div class="inspection-step">점검 입력 / 3단계</div>
        </div>
  ...
  <script>
    const metadoorData = {
      '금정구': [{ name: '금정도서관', address: '부산시 금정구 부곡동' }, { name: '금정구청', address: '부산시 금정구 중앙대로' }, { name: '금정구 보건소', address: '부산시 금정구 장전동' }],
      '기장군': [{ name: '기장군청', address: '부산시 기장군 기장읍' }, { name: '기장도서관', address: '부산시 기장군 정관면' }, { name: '정관해변공원', address: '부산시 기장군 정관면' }],
      '남구': [{ name: '남구청', address: '부산시 남구 수로왕대로' }, { name: '남부경찰서', address: '부산시 남구 용호동' }, { name: '남구문화센터', address: '부산시 남구 대티로' }],
      '동구': [{ name: '동구청', address: '부산시 동구 중앙대로' }, { name: '동부경찰서', address: '부산시 동구 초량동' }, { name: '동구도서관', address: '부산시 동구 중앙대로' }],
      '동래구': [{ name: '동래구청', address: '부산시 동래구 명륜로' }, { name: '동래도서관', address: '부산시 동래구 온천장로' }, { name: '온천장아파트', address: '부산시 동래구 온천동' }],
      '부산진구': [{ name: '부산진구청', address: '부산시 부산진구 중앙대로' }, { name: '부산진구문화센터', address: '부산시 부산진구 서면로' }, { name: '서면역', address: '부산시 부산진구 중앙대로' }],
      '북구': [{ name: '북구청', address: '부산시 북구 낙동대로' }, { name: '북구도서관', address: '부산시 북구 만평동' }, { name: '북구보건소', address: '부산시 북구 대현동' }],
      '사상구': [{ name: '사상구청', address: '부산시 사상구 사상로' }, { name: '사상도서관', address: '부산시 사상구 모라로' }, { name: '삼락공원', address: '부산시 사상구 삼락동' }],
      '사하구': [{ name: '사하구청', address: '부산시 사하구 을숙도대로' }, { name: '감천문화마을', address: '부산시 사하구 감내로' }, { name: '사하도서관', address: '부산시 사하구 신평로' }],
      '서구': [{ name: '서구청', address: '부산시 서구 서감로' }, { name: '암남공원', address: '부산시 서구 망양로' }, { name: '서구문화센터', address: '부산시 서구 구덕로' }],
      '수영구': [{ name: '수영구청', address: '부산시 수영구 남천로' }, { name: '수영도서관', address: '부산시 수영구 수영로' }, { name: '수영해수욕장', address: '부산시 수영구 광안리로' }],
      '연제구': [{ name: '연제구청', address: '부산시 연제구 중앙로' }, { name: '연제도서관', address: '부산시 연제구 중앙대로' }, { name: '연제구보건소', address: '부산시 연제구 거제로' }],
      '영도구': [{ name: '영도구청', address: '부산시 영도구 영도대로' }, { name: '영도도서관', address: '부산시 영도구 절영로' }, { name: '절영로역사관', address: '부산시 영도구 절영로' }],
      '중구': [{ name: '중구청', address: '부산시 중구 중앙대로' }, { name: '해양박물관', address: '부산시 중구 신항로' }, { name: '중구도서관', address: '부산시 중구 중앙대로' }],
      '해운대구': [{ name: '해운대구청', address: '부산시 해운대구 중앙대로' }, { name: '해운대도서관', address: '부산시 해운대구 해운대로' }, { name: '해운대해수욕장', address: '부산시 해운대구 해운대로' }]
    };
        ...
        .then(data => {
          ...
          data.forEach(insp => {
            ...
            row.innerHTML = `
              ...
              <td>${insp.content || '-'}</td>
              <td><span class="date-small">${date}</span></td>
            `;
